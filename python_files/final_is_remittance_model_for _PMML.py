...
data2=pd.read_csv(r"D:\New_folder\Modspace\CSVs\COMBINED_CSV_testing_new.csv", sep=',',encoding='cp1256',low_memory=False)
...
cols=['count_of_features','ref_no_bool','date_flag','amount_col_man','ratio_row_section','row_noOfCharacters','remittance_result','total_digits','row_distanceFromLeft','row_distanceFromTop']

#data[cols].to_csv("C:\\Users\\shubham.kamal\\Desktop\\LITM\\The_TRAINING_SET_FEATURES_VALUE.csv")
data[cols].to_csv("D:\\New_folder\\Modspace\\CSVs\\The_TRAINING_SET_FEATURES_VALUE.csv")
...
df3.to_csv("D:\\New_folder\\Modspace\\CSVs\\THE_TESTING_SET_FEATURES_VALUE.csv")
